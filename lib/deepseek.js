 ...
 * Secret Manager on Cloud Run). Models: `deepseek-chat` (V3, general) and
 * `deepseek-reasoner` (R1, stronger step-by-step reasoning).
 */
...
export function listDeepSeekModels() {
  return DEEPSEEK_KEY ? ['deepseek-chat', 'deepseek-reasoner'] : [];
}
