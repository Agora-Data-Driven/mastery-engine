...
/** Deterministic id for a Course/Lesson scope so its deck can be looked up + replaced. */
export function flashcardScopeId({ level, track, course, lesson }) {
  return slug(level || 'course', track || '', course || '', lesson || '');
}
