...
export async function addTranscript({ program, track, course, lesson, topic, title, text, source, watcherRef, copyOf, folder }) {
...
export async function updateTranscript(id, { title, text, track, course, lesson, folder } = {}) {
