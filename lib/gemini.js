...
export async function planFromSources(
  { sources = [], catalog = [], programName = '', guidance = '' },
  ai = {},
  onToken,
) {
...
3. Within each course, "lessons" — concept clusters, in teaching order (prerequisites first). Each lesson carries:
   ...
   - "sources": the [index] numbers of every source that teaches this lesson's material. Use an empty array only for a lesson you are adding to complete the subject.
 ...
 */
export async function streamAssistantChat({ context = {}, history = [], message, steer = '', catalog = [], transcripts = [], search = false, coach = false, progress = '', holistic = null, mentorHits = null, growthHits = null, work = null, workHits = null, deepHits = null, actions = false, hostFrame = false, sentinelGuide = null, attachments = [], admin = false }, ai = {}, onToken) {
