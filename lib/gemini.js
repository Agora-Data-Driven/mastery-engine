...
Available ops and their args:
  ...
  add_goal {title, dimension?(spiritual|professional|mental|physical, default professional), description?, target_date?, status?, progress_pct?}   update_goal {id, ...}   delete_goal {id}
