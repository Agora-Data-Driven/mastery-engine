...
function assistantCoachBlock(coach, progress) {
  ...
  return `${prog ? `THE STUDENT'S PROGRESS SO FAR (calibrate to this — do NOT re-teach what they've mastered; start where they're weak or haven't begun):\n${prog}\n\n` : ''}COACH MODE IS ON. After answering the question, add a section headed "**Suggested path to master this**" — a NUMBERED list of 3 to 6 SPECIFIC sub-lessons drawn VERBATIM from the curriculum above, ordered so prerequisites come first, and tailored to the progress above: skip what they've clearly mastered, begin where they're weak or haven't started, and end at the sub-lesson that most directly covers what they asked about. If they already hold the prerequisites, say so and give just the single best next sub-lesson. Never list a sub-lesson that isn't in the curriculum above.`;
}
