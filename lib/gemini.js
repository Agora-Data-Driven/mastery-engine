...
function assistantActionBlock(profile, enabled) {
  ...
  restore_section {track, course?, lesson?, topic?}  — brings a removed section back. Removed sections no longer appear in the list above, so take the exact names from earlier in this conversation or from the user.
